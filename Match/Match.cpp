...
void Match::enterResultMatch()
{
    ...
    cin >> g2;
    // cout << "Nhap ban thang cho cau thu ghi ban: ";
    ...
    do
    {
        ...
        if(g1 > 0)
        {
            ...
            if(checkidPlayerofTeam(id1, idm) == true)
            {
                cout << "Nhap so ban thang: ";
                String::getline(cin, goal1);
                if(String::toint(goal1) <= g1)
                {
                    dem1 = dem1 + String::toint(goal1);
                    kiemtra = kiemtra + String::toint(goal1);
                    Player::updatePlayerAfterMatch(idm, 0, 0, String::toint(goal1));
                }                
            }
        }
        if(g2 > 0)
        {
            ...
            if(checkidPlayerofTeam(id2, idh) == true)
            {
                cout << "Nhap so ban thang: ";
                String::getline(cin, goal2);
                if(String::toint(goal2) <= g1)
                {
                    kiemtra = kiemtra + String::toint(goal2);
                    Player::updatePlayerAfterMatch(idm, 0, 0, String::toint(goal2));
                }                
            }
        }
    } while (kiemtra != sum);
    ...
    do
    {
        ...
        //     system("cls");
        //     String id, goal;
        //     cout << "QUAN LY GIAI DAU/Cap nhat thong tin tran dau/Them ket qua cho tran dau/Nhap ban thang cho cau thu" << endl
        //          << endl;
        //     cout << "Danh sach cau thu cua doi bong co ID la " << id1 << " (" << name1 << ")" << endl;
        //     showPlayerofTeam(name1);
        //     cout << endl;
